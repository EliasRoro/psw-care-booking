...
export default function AdminDashboard() {
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      ...
      <View style={styles.actionGrid}><Link href="/admin-approvals" asChild><Pressable style={styles.actionCard}><Text style={styles.actionTitle}>PSW approvals</Text><Text style={styles.actionText}>Review documents and approve caregivers</Text></Pressable></Link><Link href="/admin-bookings" asChild><Pressable style={styles.actionCard}><Text style={styles.actionTitle}>Assign bookings</Text><Text style={styles.actionText}>Match requests with approved PSWs</Text></Pressable></Link><Link href="/admin-incidents" asChild><Pressable style={styles.actionCard}><Text style={styles.actionTitle}>Incident log</Text><Text style={styles.actionText}>Record and resolve operational issues</Text></Pressable></Link><Link href="/caregivers" asChild><Pressable style={styles.actionCard}><Text style={styles.actionTitle}>Team directory</Text><Text style={styles.actionText}>Review caregiver profiles and availability</Text></Pressable></Link><Link href="/schedule" asChild><Pressable style={styles.actionCard}><Text style={styles.actionTitle}>Coverage calendar</Text><Text style={styles.actionText}>See upcoming visits and open slots</Text></Pressable></Link></View>
